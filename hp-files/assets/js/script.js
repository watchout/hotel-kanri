...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            if (!isValidEmail(email)) {
                showAlert('有効なメールアドレスを入力してください。', 'danger');
                return;
            }
            ...
            setTimeout(() => {
                showAlert('お問い合わせありがとうございます。後日ご連絡いたします。', 'success');
                contactForm.reset();
    ...
    console.log('%c🤖 omotenasuAI', 'color: #0d6efd; font-size: 24px; font-weight: bold;');
    console.log('%cAIが創る新しいおもてなし体験', 'color: #6c757d; font-size: 14px;');
