    ...
    <div class="modal" @click.stop>
      ...
      <form @submit.prevent="submit" class="form">
        ...
        <div class="form-group">
          ...
          <textarea v-model="form.description" placeholder="タスクの詳細"></textarea>
        </div>
        ...
        <div class="form-group">
          ...
          <select v-model="form.category" required>
            ...
            <option value="GUEST_INFO">ゲスト情報</option>
            <option value="ROOM_STATUS">客室状況</option>
            <option value="MAINTENANCE">メンテナンス</option>
            <option value="CLEANING">清掃</option>
            <option value="BILLING">請求</option>
            <option value="EMERGENCY">緊急</option>
            <option value="DOCUMENTATION">書類</option>
        ...
        <div class="form-group">
          ...
          <textarea v-model="form.notes" placeholder="タスクに関するメモ"></textarea>
        </div>
