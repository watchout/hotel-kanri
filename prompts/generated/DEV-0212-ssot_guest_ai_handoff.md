# DEV-0212: AIチャットでは対応困難な問い合わせを、60秒以内にスタッフ

**タスクタイプ**: fullstack
**推定工数**: 39時間
**生成日時**: 2026-01-18T06:25:23.427Z
...
```bash
echo "=== DEV-0212 実行ログ ===" > evidence/DEV-0212/commands.log

# 実行したコマンドを記録
echo "$ npm run dev" >> evidence/DEV-0212/commands.log
echo "Exit code: $?" >> evidence/DEV-0212/commands.log
```

### Evidence 2: Files
```bash
echo "=== 作成/変更ファイル ===" > evidence/DEV-0212/files.log
git status --short >> evidence/DEV-0212/files.log
ls -la <作成ファイル> >> evidence/DEV-0212/files.log
```

### Evidence 3: Git
```bash
echo "=== Git状態 ===" > evidence/DEV-0212/git.log
git branch --show-current >> evidence/DEV-0212/git.log
git log --oneline -3 >> evidence/DEV-0212/git.log
```

### Evidence 4: Test
```bash
echo "=== テスト結果 ===" > evidence/DEV-0212/test.log
./scripts/test-standard-guest.sh >> evidence/DEV-0212/test.log 2>&1
# または
./scripts/test-standard-admin.sh >> evidence/DEV-0212/test.log 2>&1
```
...
### Evidence
- `evidence/DEV-0212/commands.log`
- `evidence/DEV-0212/files.log`
- `evidence/DEV-0212/git.log`
- `evidence/DEV-0212/test.log`
...
# DEV-0212: AIチャットでは対応困難な問い合わせを、60秒以内にスタッフ - Backend API実装
...
```bash
# ゲストAPI用
./scripts/test-standard-guest.sh 2>&1 | tee evidence/DEV-0212/test.log

# または管理画面API用
./scripts/test-standard-admin.sh 2>&1 | tee evidence/DEV-0212/test.log
```

### Step 2: Evidence保存
```bash
mkdir -p evidence/DEV-0212
echo "=== DEV-0212 Evidence ===" > evidence/DEV-0212/commands.log
git status --short >> evidence/DEV-0212/commands.log
ls -la hotel-common-rebuild/src/routes/handoff.routes.ts >> evidence/DEV-0212/commands.log
```
